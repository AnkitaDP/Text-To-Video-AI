...
import { TitledVideo, calculateTitledVideoMetadata } from "./TitledVideo";
  ...
  return (
    <>
      ...
      <Composition
        ...
        width={1080}
        height={1920}
        defaultProps={{ cuts: [], overlays: [], captions: [], audio: {} }}
      ...
      <Composition
        ...
        height={1920}
        defaultProps={
          { videoSrc: "", lyrics: [], bottomY: 0.88 } as LyricOverlayProps
        }
      />{" "}
      <Composition
        id="EndTag"
